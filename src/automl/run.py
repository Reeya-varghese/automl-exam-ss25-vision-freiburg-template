#reeya's run file with updated carbon emission strategies: (there are comments in the bottom, remove them when finalising)
import argparse
import contextlib
import logging
import warnings
...
# NEW: Progressive training strategy (kept for backward compatibility)
...
def optuna_objective(
    ...
    # NEW: Update carbon budget manager
    if carbon_budget_manager:
...
if __name__ == "__main__":
    ...
    # NEW: Print carbon budget summary if manager was used
    if carbon_budget_manager:
